...
I work on B2B and AI-adjacent platforms where:

- Business workflows span multiple actors and systems  
...
- Manual exploration to understand real user behavior  
- Decomposition of complex workflows into testable units  
- Selective automation for high-impact flows  
...
Automation & Testing: Selenium, REST Assured, Cucumber, TestNG, JUnit, JMeter  
Tools: Postman, Swagger, Maven, Jenkins, Docker, Git, JIRA  
Languages: Java  
